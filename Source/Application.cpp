...
void Application::Start() {
	...
	grid = new Grid_Tiles(app->GetRenderer(), app->GetEvent(), &erase, &paint);
...
void Application::MainLoop() {
	//Text tmpText(app->GetRenderer(), Vec2(selectTilesetB.GetDestPos().x - 200, 0), Assets::GetFont("Files/Fonts/8-bit-operator/8bitOperatorPlus8-Regular.ttf"), "Rows: ", { 255,255,255,0 });

	println("TESTING HALOO\n");
	while (isRunning) {
